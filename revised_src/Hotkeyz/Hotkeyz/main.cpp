...
bool load_files()
{
    background[0][0] = load_image("./Resources/background1_ws.png");
    background[0][1] = load_image("./Resources/yayBG.png");
    background[0][2] = load_image("./Resources/booBG.png");
    background[0][3] = load_image("./Resources/dieBG.png");
    background[1][0] = load_image("./Resources/inverted.png");
    background[1][1] = load_image("./Resources/invertedYay.png");
    background[1][2] = load_image("./Resources/invertedBoo.png");
    background[1][3] = load_image("./Resources/dieBG.png");
    ptImg[0][0] = load_image("./Resources/key1.png");
    ptImg[0][1] = load_image("./Resources/key2.png");
    ptImg[0][2] = load_image("./Resources/key3.png");
    ptImg[0][3] = load_image("./Resources/key4.png");
    ptImg[0][4] = load_image("./Resources/key5.png");
    ptImg[0][5] = load_image("./Resources/key6.png");
    ptImg[0][6] = load_image("./Resources/key7.png");
    ptImg[0][7] = load_image("./Resources/key8.png");
    ptImg[0][8] = load_image("./Resources/key9.png");
    ptImg[0][9] = load_image("./Resources/key11.png");
    ptImg[0][10] = load_image("./Resources/key14.png");
    ptImg[0][11] = load_image("./Resources/key15.png");
    ptImg[1][0] = load_image("./Resources/key1b.png");
    ptImg[1][1] = load_image("./Resources/key2b.png");
    ptImg[1][2] = load_image("./Resources/key3b.png");
    ptImg[1][3] = load_image("./Resources/key4b.png");
    ptImg[1][4] = load_image("./Resources/key5b.png");
    ptImg[1][5] = load_image("./Resources/key6b.png");
    ptImg[1][6] = load_image("./Resources/key7b.png");
    ptImg[1][7] = load_image("./Resources/key8b.png");
    ptImg[1][8] = load_image("./Resources/key9b.png");
    ptImg[1][9] = load_image("./Resources/key10b.png");
    ptImg[1][10] = load_image("./Resources/key11b.png");
    ptImg[1][11] = load_image("./Resources/key12b.png");
    csFrame = load_image("./Resources/cs_frame.png");
    csPowerup = load_image("./Resources/cs_powerup.png");
    review[0] = load_image("./Resources/review1.png");
    review[1] = load_image("./Resources/review2.png");
    review[2] = load_image("./Resources/review3.png");
    review[3] = load_image("./Resources/review4.png");
    review[4] = load_image("./Resources/review5.png");
    review[5] = load_image("./Resources/review6.png");
    review[6] = load_image("./Resources/review7.png");
    scReview[0] = load_image("./Resources/scReview1.png");
    scReview[1] = load_image("./Resources/scReview2.png");
    scReview[2] = load_image("./Resources/scReview3.png");
    scReview[3] = load_image("./Resources/scReview4.png");
    scReview[4] = load_image("./Resources/scReview5.png");
    scReview[5] = load_image("./Resources/scReview6.png");
    scReview[6] = load_image("./Resources/scReview7a.png");
    scReview[7] = load_image("./Resources/scReview7b.png");
    scIcon[0] = load_image("./Resources/f1.png");
    scIcon[1] = load_image("./Resources/f2.png");
    scIcon[2] = load_image("./Resources/f3.png");
    scIcon[3] = load_image("./Resources/f4.png");
    scIcon[4] = load_image("./Resources/ctrl_R.png");
    scIcon[5] = load_image("./Resources/ctrl_T.png");
    scIcon[6] = load_image("./Resources/return.png");
    scIcon[7] = load_image("./Resources/opt_return.png");
    scIcon[8] = load_image("./Resources/ctrl6.png");
    scIcon[9] = load_image("./Resources/ctrl7.png");
    scIcon[10] = load_image("./Resources/ctrl_up.png");
    scIcon[11] = load_image("./Resources/ctrl_down.png");
    scIcon[12] = load_image("./Resources/opt_openBracket.png");
    scIcon[13] = load_image("./Resources/opt_closeBracket.png");
    scIcon[14] = load_image("./Resources/opt_minus.png");
    scIcon[15] = load_image("./Resources/cmd_equal.png");
    scIcon[16] = load_image("./Resources/cmdShft_N.png");
    scIcon[17] = load_image("./Resources/cmd_K.png");
    scIcon[18] = load_image("./Resources/cmd4.png");
    scIcon[19] = load_image("./Resources/cmd5.png");
    scIcon[20] = load_image("./Resources/cmd6.png");
    scIcon[21] = load_image("./Resources/cmd7.png");
    scIcon[22] = load_image("./Resources/shft1.png");
    scIcon[23] = load_image("./Resources/shftS.png");
    scIcon[24] = load_image("./Resources/cmdG.png");
    scIcon[25] = load_image("./Resources/optShft_D.png");
    scIcon[26] = load_image("./Resources/ctrl_tab.png");
    scIcon[27] = load_image("./Resources/ctrlOpt_tab.png");
    scIcon[28] = load_image("./Resources/ctrlP.png");
    scIcon[29] = load_image("./Resources/ctrl_semicolon.png");
    scIcon[30] = load_image("./Resources/tab.png");
    scIcon[31] = load_image("./Resources/opt_tab.png");
    scIcon[32] = load_image("./Resources/opt_KPplus.png");
    scIcon[33] = load_image("./Resources/opt_KPminus.png");
    scIcon[34] = load_image("./Resources/ctrlB.png");
    scIcon[35] = load_image("./Resources/cmdH.png");
    mic[0] = load_image("./Resources/shotgunMic.png");
    mic[1] = load_image("./Resources/shotgunMicArrows.png");
    scBackground[0] = load_image("./Resources/scBackground.png");
    scBackground[1] = load_image("./Resources/scBackground_die.png");
    scBackground[2] = load_image("./Resources/scBackground_cs.png");
    warning = load_image("./Resources/warning.png");
    wrongAns = load_image("./Resources/ban.png");
    rightAns = load_image("./Resources/checkmark.png");
    scClockStop = load_image("./Resources/scClockStop.png");
    wave[0][0] = load_image("./Resources/wave1a.png");
    wave[0][1] = load_image("./Resources/wave1b.png");
    wave[0][2] = load_image("./Resources/wave1c.png");
    wave[0][3] = load_image("./Resources/wave1d.png");
    wave[1][0] = load_image("./Resources/wave2a.png");
    wave[1][1] = load_image("./Resources/wave2b.png");
    wave[1][2] = load_image("./Resources/wave2c.png");
    wave[1][3] = load_image("./Resources/wave2d.png");
    wave[2][0] = load_image("./Resources/wave3a.png");
    wave[2][1] = load_image("./Resources/wave3b.png");
    wave[2][2] = load_image("./Resources/wave3c.png");
    wave[2][3] = load_image("./Resources/wave3d.png");
    wave[3][0] = load_image("./Resources/wave4a.png");
    wave[3][1] = load_image("./Resources/wave4b.png");
    wave[3][2] = load_image("./Resources/wave4c.png");
    wave[3][3] = load_image("./Resources/wave4d.png");
    wave[4][0] = load_image("./Resources/wave5a.png");
    wave[4][1] = load_image("./Resources/wave5b.png");
    wave[4][2] = load_image("./Resources/wave5c.png");
    wave[4][3] = load_image("./Resources/wave5d.png");
    keyboardPrompt = load_image("./Resources/keyboard_prompt.png");
    keyboardTypes[0] = load_image("./Resources/fullSized.png");
    keyboardTypes[1] = load_image("./Resources/laptop.png");
    endScreen = load_image("./Resources/endScreen.png");
    pauseMenu[0] = load_image("./Resources/pause1.png");
    pauseMenu[1] = load_image("./Resources/pause2.png");

    font = TTF_OpenFont("./Resources/Arial Bold.ttf", 32);
    smallFont = TTF_OpenFont("./Resources/Arial.ttf", 26);
    bigFont = TTF_OpenFont("./Resources/Arial Bold.ttf", 50);

    failSnd = Mix_LoadWAV("./Resources/failB.wav");
    dieSnd = Mix_LoadWAV("./Resources/deathSound.wav");
    succeedSnd = Mix_LoadWAV("./Resources/succeed2.wav");
    csMusic = Mix_LoadWAV("./Resources/csMusicA.wav");
    scStartSound[0] = Mix_LoadWAV("./Resources/startSound.wav");
    scStartSound[1] = Mix_LoadWAV("./Resources/startSound2.wav");
    scGoodSound = Mix_LoadWAV("./Resources/scGoodSound.wav");
    scBadSound = Mix_LoadWAV("./Resources/scBadSound.wav");
    oneUpSnd2 = Mix_LoadWAV("./Resources/oneUp2a.wav");
    oneUpSnd1 = Mix_LoadWAV("./Resources/oneUp1.wav");

    BGmusic2 = Mix_LoadMUS("./Resources/BGmusic2a.wav");
    BGmusic1[0] = Mix_LoadMUS("./Resources/BGmusic1.wav");
    BGmusic1[1] = Mix_LoadMUS("./Resources/BGmusic1_faster.wav");
    BGmusic1[2] = Mix_LoadMUS("./Resources/BGmusic1_fastest.wav");
    finaleMusic1[0] = Mix_LoadMUS("./Resources/finale1b.wav");
    finaleMusic1[1] = Mix_LoadMUS("./Resources/finale1_faster.wav");
    finaleMusic1[2] = Mix_LoadMUS("./Resources/finaleMusic1_fastest.wav");
    finaleMusic2 = Mix_LoadMUS("./Resources/finale2.wav");
    reviewMusic2 = Mix_LoadMUS("./Resources/reviewMusic2.wav");
    reviewMusic1 = Mix_LoadMUS("./Resources/reviewMusic1.wav");
    badFinaleMusic1 = Mix_LoadMUS("./Resources/badFinale1.wav");
    badFinaleMusic2 = Mix_LoadMUS("./Resources/badFinale2.wav");
...
bool getKeyboardType()
{
    ...
    if (kbType == 1)
    {
        ...
        scReview[4] = load_image("./Resources/scReview5b.png");
        scReview[5] = load_image("./Resources/scReview6b.png");
        scReview[7] = load_image("./Resources/scReview7bB.png");
        scIcon[32] = load_image("./Resources/ctrl_period.png");
        scIcon[33] = load_image("./Resources/ctrl_comma.png");
