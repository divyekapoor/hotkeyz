...
std::string get_resources_dir() {
    ...
    UInt8 fileSystemBasePath[(1<<20)];
    Boolean resolveAgainstBase = true;
    CFIndex size = sizeof(fileSystemBasePath) - 1;
    CFURLGetFileSystemRepresentation(resourceUrl, resolveAgainstBase, fileSystemBasePath, size);
    std::ostringstream os;
    os << fileSystemBasePath;
    return os.str();
}
...
Mix_Chunk* load_wav(std::string wavPath) {
    return Mix_LoadWAV(wavPath.c_str());
}

Mix_Music* load_mus(std::string musicPath) {
    return Mix_LoadMUS(musicPath.c_str());
}

bool load_files()
{
    std::string resourcesDir = get_resources_dir();
    background[0][0] = load_image(resourcesDir + "/background1_ws.png");
    background[0][1] = load_image(resourcesDir + "/yayBG.png");
    background[0][2] = load_image(resourcesDir + "/booBG.png");
    background[0][3] = load_image(resourcesDir + "/dieBG.png");
    background[1][0] = load_image(resourcesDir + "/inverted.png");
    background[1][1] = load_image(resourcesDir + "/invertedYay.png");
    background[1][2] = load_image(resourcesDir + "/invertedBoo.png");
    background[1][3] = load_image(resourcesDir + "/dieBG.png");
    ptImg[0][0] = load_image(resourcesDir + "/key1.png");
    ptImg[0][1] = load_image(resourcesDir + "/key2.png");
    ptImg[0][2] = load_image(resourcesDir + "/key3.png");
    ptImg[0][3] = load_image(resourcesDir + "/key4.png");
    ptImg[0][4] = load_image(resourcesDir + "/key5.png");
    ptImg[0][5] = load_image(resourcesDir + "/key6.png");
    ptImg[0][6] = load_image(resourcesDir + "/key7.png");
    ptImg[0][7] = load_image(resourcesDir + "/key8.png");
    ptImg[0][8] = load_image(resourcesDir + "/key9.png");
    ptImg[0][9] = load_image(resourcesDir + "/key11.png");
    ptImg[0][10] = load_image(resourcesDir + "/key14.png");
    ptImg[0][11] = load_image(resourcesDir + "/key15.png");
    ptImg[1][0] = load_image(resourcesDir + "/key1b.png");
    ptImg[1][1] = load_image(resourcesDir + "/key2b.png");
    ptImg[1][2] = load_image(resourcesDir + "/key3b.png");
    ptImg[1][3] = load_image(resourcesDir + "/key4b.png");
    ptImg[1][4] = load_image(resourcesDir + "/key5b.png");
    ptImg[1][5] = load_image(resourcesDir + "/key6b.png");
    ptImg[1][6] = load_image(resourcesDir + "/key7b.png");
    ptImg[1][7] = load_image(resourcesDir + "/key8b.png");
    ptImg[1][8] = load_image(resourcesDir + "/key9b.png");
    ptImg[1][9] = load_image(resourcesDir + "/key10b.png");
    ptImg[1][10] = load_image(resourcesDir + "/key11b.png");
    ptImg[1][11] = load_image(resourcesDir + "/key12b.png");
    csFrame = load_image(resourcesDir + "/cs_frame.png");
    csPowerup = load_image(resourcesDir + "/cs_powerup.png");
    review[0] = load_image(resourcesDir + "/review1.png");
    review[1] = load_image(resourcesDir + "/review2.png");
    review[2] = load_image(resourcesDir + "/review3.png");
    review[3] = load_image(resourcesDir + "/review4.png");
    review[4] = load_image(resourcesDir + "/review5.png");
    review[5] = load_image(resourcesDir + "/review6.png");
    review[6] = load_image(resourcesDir + "/review7.png");
    scReview[0] = load_image(resourcesDir + "/scReview1.png");
    scReview[1] = load_image(resourcesDir + "/scReview2.png");
    scReview[2] = load_image(resourcesDir + "/scReview3.png");
    scReview[3] = load_image(resourcesDir + "/scReview4.png");
    scReview[4] = load_image(resourcesDir + "/scReview5.png");
    scReview[5] = load_image(resourcesDir + "/scReview6.png");
    scReview[6] = load_image(resourcesDir + "/scReview7a.png");
    scReview[7] = load_image(resourcesDir + "/scReview7b.png");
    scIcon[0] = load_image(resourcesDir + "/f1.png");
    scIcon[1] = load_image(resourcesDir + "/f2.png");
    scIcon[2] = load_image(resourcesDir + "/f3.png");
    scIcon[3] = load_image(resourcesDir + "/f4.png");
    scIcon[4] = load_image(resourcesDir + "/ctrl_R.png");
    scIcon[5] = load_image(resourcesDir + "/ctrl_T.png");
    scIcon[6] = load_image(resourcesDir + "/return.png");
    scIcon[7] = load_image(resourcesDir + "/opt_return.png");
    scIcon[8] = load_image(resourcesDir + "/ctrl6.png");
    scIcon[9] = load_image(resourcesDir + "/ctrl7.png");
    scIcon[10] = load_image(resourcesDir + "/ctrl_up.png");
    scIcon[11] = load_image(resourcesDir + "/ctrl_down.png");
    scIcon[12] = load_image(resourcesDir + "/opt_openBracket.png");
    scIcon[13] = load_image(resourcesDir + "/opt_closeBracket.png");
    scIcon[14] = load_image(resourcesDir + "/opt_minus.png");
    scIcon[15] = load_image(resourcesDir + "/cmd_equal.png");
    scIcon[16] = load_image(resourcesDir + "/cmdShft_N.png");
    scIcon[17] = load_image(resourcesDir + "/cmd_K.png");
    scIcon[18] = load_image(resourcesDir + "/cmd4.png");
    scIcon[19] = load_image(resourcesDir + "/cmd5.png");
    scIcon[20] = load_image(resourcesDir + "/cmd6.png");
    scIcon[21] = load_image(resourcesDir + "/cmd7.png");
    scIcon[22] = load_image(resourcesDir + "/shft1.png");
    scIcon[23] = load_image(resourcesDir + "/shftS.png");
    scIcon[24] = load_image(resourcesDir + "/cmdG.png");
    scIcon[25] = load_image(resourcesDir + "/optShft_D.png");
    scIcon[26] = load_image(resourcesDir + "/ctrl_tab.png");
    scIcon[27] = load_image(resourcesDir + "/ctrlOpt_tab.png");
    scIcon[28] = load_image(resourcesDir + "/ctrlP.png");
    scIcon[29] = load_image(resourcesDir + "/ctrl_semicolon.png");
    scIcon[30] = load_image(resourcesDir + "/tab.png");
    scIcon[31] = load_image(resourcesDir + "/opt_tab.png");
    scIcon[32] = load_image(resourcesDir + "/opt_KPplus.png");
    scIcon[33] = load_image(resourcesDir + "/opt_KPminus.png");
    scIcon[34] = load_image(resourcesDir + "/ctrlB.png");
    scIcon[35] = load_image(resourcesDir + "/cmdH.png");
    mic[0] = load_image(resourcesDir + "/shotgunMic.png");
    mic[1] = load_image(resourcesDir + "/shotgunMicArrows.png");
    scBackground[0] = load_image(resourcesDir + "/scBackground.png");
    scBackground[1] = load_image(resourcesDir + "/scBackground_die.png");
    scBackground[2] = load_image(resourcesDir + "/scBackground_cs.png");
    warning = load_image(resourcesDir + "/warning.png");
    wrongAns = load_image(resourcesDir + "/ban.png");
    rightAns = load_image(resourcesDir + "/checkmark.png");
    scClockStop = load_image(resourcesDir + "/scClockStop.png");
    wave[0][0] = load_image(resourcesDir + "/wave1a.png");
    wave[0][1] = load_image(resourcesDir + "/wave1b.png");
    wave[0][2] = load_image(resourcesDir + "/wave1c.png");
    wave[0][3] = load_image(resourcesDir + "/wave1d.png");
    wave[1][0] = load_image(resourcesDir + "/wave2a.png");
    wave[1][1] = load_image(resourcesDir + "/wave2b.png");
    wave[1][2] = load_image(resourcesDir + "/wave2c.png");
    wave[1][3] = load_image(resourcesDir + "/wave2d.png");
    wave[2][0] = load_image(resourcesDir + "/wave3a.png");
    wave[2][1] = load_image(resourcesDir + "/wave3b.png");
    wave[2][2] = load_image(resourcesDir + "/wave3c.png");
    wave[2][3] = load_image(resourcesDir + "/wave3d.png");
    wave[3][0] = load_image(resourcesDir + "/wave4a.png");
    wave[3][1] = load_image(resourcesDir + "/wave4b.png");
    wave[3][2] = load_image(resourcesDir + "/wave4c.png");
    wave[3][3] = load_image(resourcesDir + "/wave4d.png");
    wave[4][0] = load_image(resourcesDir + "/wave5a.png");
    wave[4][1] = load_image(resourcesDir + "/wave5b.png");
    wave[4][2] = load_image(resourcesDir + "/wave5c.png");
    wave[4][3] = load_image(resourcesDir + "/wave5d.png");
    keyboardPrompt = load_image(resourcesDir + "/keyboard_prompt.png");
    keyboardTypes[0] = load_image(resourcesDir + "/fullSized.png");
    keyboardTypes[1] = load_image(resourcesDir + "/laptop.png");
    endScreen = load_image(resourcesDir + "/endScreen.png");
    pauseMenu[0] = load_image(resourcesDir + "/pause1.png");
    pauseMenu[1] = load_image(resourcesDir + "/pause2.png");
    
    // Must specify the strings separately or you risk a use-after-free.
    std::string arialBoldPath = resourcesDir + "/Arial Bold.ttf";
    std::string arialPath = resourcesDir + "/Arial.ttf";
    font = load_font(arialBoldPath, 32);
    smallFont = load_font(arialPath, 26);
    bigFont = load_font(arialBoldPath, 50);
    
    failSnd = load_wav(resourcesDir + "/failB.wav");
    dieSnd = load_wav(resourcesDir + "/deathSound.wav");
    succeedSnd = load_wav(resourcesDir + "/succeed2.wav");
    csMusic = load_wav(resourcesDir + "/csMusicA.wav");
    scStartSound[0] = load_wav(resourcesDir + "/startSound.wav");
    scStartSound[1] = load_wav(resourcesDir + "/startSound2.wav");
    scGoodSound = load_wav(resourcesDir + "/scGoodSound.wav");
    scBadSound = load_wav(resourcesDir + "/scBadSound.wav");
    oneUpSnd2 = load_wav(resourcesDir + "/oneUp2a.wav");
    oneUpSnd1 = load_wav(resourcesDir + "/oneUp1.wav");
    
    BGmusic2 = load_mus(resourcesDir + "/BGmusic2a.wav");
    BGmusic1[0] = load_mus(resourcesDir + "/BGmusic1.wav");
    BGmusic1[1] = load_mus(resourcesDir + "/BGmusic1_faster.wav");
    BGmusic1[2] = load_mus(resourcesDir + "/BGmusic1_fastest.wav");
    finaleMusic1[0] = load_mus(resourcesDir + "/finale1b.wav");
    finaleMusic1[1] = load_mus(resourcesDir + "/finale1_faster.wav");
    finaleMusic1[2] = load_mus(resourcesDir + "/finaleMusic1_fastest.wav");
    finaleMusic2 = load_mus(resourcesDir + "/finale2.wav");
    reviewMusic2 = load_mus(resourcesDir + "/reviewMusic2.wav");
    reviewMusic1 = load_mus(resourcesDir + "/reviewMusic1.wav");
    badFinaleMusic1 = load_mus(resourcesDir + "/badFinale1.wav");
    badFinaleMusic2 = load_mus(resourcesDir + "/badFinale2.wav");
...
bool getKeyboardType()
{
    ...
    if (kbType == 1)
    {
        ...
        scIcon[33] = NULL;
        std::string resourcesDir = get_resources_dir();
        scReview[4] = load_image(resourcesDir + "/scReview5b.png");
        scReview[5] = load_image(resourcesDir + "/scReview6b.png");
        scReview[7] = load_image(resourcesDir + "/scReview7bB.png");
        scIcon[32] = load_image(resourcesDir + "/ctrl_period.png");
        scIcon[33] = load_image(resourcesDir + "/ctrl_comma.png");
